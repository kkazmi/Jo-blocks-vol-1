          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Exchange Your BTC To JOB</h2>
                   <div class="title_right">
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group pull-right" style="text-align:center;
">

                              <div class="alert alert-block alert-success"><strong> Currenct exchnage rate : 1 BTC = <?php echo $askdata?> JOB</strong></div>
        ...
        <?php } ?>
                    <form action="<?php echo base_url()?>exchange/" method="POST" id="sendform" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">JOB Amount <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
